...
Object.assign(translations, {
    ...
    'cat-transport-trailer': { fa: 'تریلر', en: 'Trailers', ps: 'ټرېلرونه' },
    'cat-transport-truck': { fa: 'کامیون', en: 'Trucks', ps: 'لارۍ' },
    'cat-transport-forklift': { fa: 'لیفتراک', en: 'Forklifts', ps: 'فورکلیفتونه' },
    'cat-extruder-line': { fa: 'خط اکسترودر', en: 'Extruder Lines', ps: 'اکسترودر لینونه' },
    'cat-injection-molding': { fa: 'تزریق پلاستیک', en: 'Injection Molding', ps: 'د پلاستیک انجکشن' },
    'cat-packaging-machinery': { fa: 'ماشین آلات بسته بندی', en: 'Packaging Machinery', ps: 'د بسته بندۍ ماشینونه' },
    'cat-industrial-vacuum': { fa: 'وکیوم صنعتی', en: 'Industrial Vacuum', ps: 'صنعتي ویکیوم' },
    'cat-packaging-printing': { fa: 'چاپ بسته‌بندی', en: 'Packaging Printing', ps: 'د بسته بندۍ چاپ' },
    'cat-melting-furnace': { fa: 'کوره ذوب', en: 'Melting Furnaces', ps: 'د وېلې کولو بټۍ' },
    'cat-rolling-mill': { fa: 'خط نورد', en: 'Rolling Mills', ps: 'نورد لینونه' },
    'cat-powder-coating': { fa: 'پوشش پودری', en: 'Powder Coating', ps: 'پوډري کوټینګ' },
    'cat-pcb-assembly': { fa: 'مونتاژ PCB', en: 'PCB Assembly', ps: 'د PCB اسمبلۍ' },
    'cat-industrial-laser': { fa: 'لیزر صنعتی', en: 'Industrial Lasers', ps: 'صنعتي لېزرونه' },
    'cat-solar-energy': { fa: 'انرژی خورشیدی', en: 'Solar Energy', ps: 'لمرینې انرژي' },
    'cat-industrial-chiller': { fa: 'چیلر صنعتی', en: 'Industrial Chillers', ps: 'صنعتي چیلرونه' },
    'cat-steam-boiler': { fa: 'بویلر بخار', en: 'Steam Boilers', ps: 'د بخار بویلرونه' },
    'cat-cooling-tower': { fa: 'برج خنک‌کن', en: 'Cooling Towers', ps: 'د یخولو برجونه' },
    'cat-site-workshop': { fa: 'کارگاه عمرانی', en: 'Construction Workshops', ps: 'د ساختماني ورکشاپونه' },
    'cat-formwork-concrete': { fa: 'قالب‌بندی و بتن', en: 'Formwork & Concrete', ps: 'فارم ورک او کانکریټ' },
    'cat-trailer-tires': { fa: 'تایر تریلر', en: 'Trailer Tires', ps: 'د ټرېلر ټایرونه' },
    'cat-truck-tires': { fa: 'تایر کامیون', en: 'Truck Tires', ps: 'د لارۍ ټایرونه' },
    'cat-heavy-equipment-tires': { fa: 'تایر ماشین آلات سنگین', en: 'Heavy Equipment Tires', ps: 'د درنو ماشینونو ټایرونه' },
    'cat-machinery-spares': { fa: 'پرزه‌جات ماشین‌آلات', en: 'Machinery Spare Parts', ps: 'د ماشین پرزې' },
    'cat-hydraulic-parts': { fa: 'قطعات هیدرولیک', en: 'Hydraulic Parts', ps: 'هایډرولیک پرزې' },
    'cat-molds-gearboxes': { fa: 'قالب و گیربکس', en: 'Molds & Gearboxes', ps: 'قالبونه او ګیربکسونه' },
    'cat-second-hand-machinery': { fa: 'ماشین آلات دست دوم', en: 'Second-Hand Machinery', ps: 'دوهم لاس ماشینونه' },
    'cat-technical-inspection': { fa: 'بازرسی فنی', en: 'Technical Inspection', ps: 'تخنیکي تفتیش' },
    'cat-heavy-machinery': { fa: 'ماشین آلات سنگین', en: 'Heavy Machinery', ps: 'درنې ماشینونه' },
    'cat-centrifugal-pump': { fa: 'پمپ سانتریفیوژ', en: 'Centrifugal Pumps', ps: 'سنټرفیوژ پمپونه' },
    'cat-screw-compressor': { fa: 'کمپرسور پیچ', en: 'Screw Compressors', ps: 'سکرو کمپرسورونه' },
    'cat-vacuum-system': { fa: 'سیستم وکیوم', en: 'Vacuum Systems', ps: 'د ویکیوم سیستمونه' },
    'cat-pulping-machine': { fa: 'ماشین خمیرسازی', en: 'Pulping Machines', ps: 'د خمیر جوړولو ماشینونه' },
    'cat-paper-machine': { fa: 'ماشین کاغذ', en: 'Paper Machines', ps: 'د کاغذ ماشینونه' },
    'cat-tissue-converting': { fa: 'تبدیل دستمال کاغذی', en: 'Tissue Converting', ps: 'د دستمال بدلون' },
    'cat-chemical-reactor': { fa: 'راکتور شیمیایی', en: 'Chemical Reactors', ps: 'کیمیاوي ریکتورونه' },
    'cat-storage-tank': { fa: 'تانک ذخیره', en: 'Storage Tanks', ps: 'د ذخیرې ټانکونه' },
    'cat-foam-equipment': { fa: 'تجهیزات فوم', en: 'Foam Equipment', ps: 'د فوم تجهیزات' },
    'cat-raw-materials': { fa: 'مواد اولیه صنعتی', en: 'Industrial Raw Materials', ps: 'صنعتي لومړني مواد' },
    'cat-steel': { fa: 'فولاد', en: 'Steel', ps: 'فولاد' },
    'cat-polymers': { fa: 'پلیمر', en: 'Polymers', ps: 'پوليمرونه' },
    'cat-chemicals': { fa: 'مواد شیمیایی', en: 'Chemicals', ps: 'کيمياوي مواد' },
    'cat-minerals': { fa: 'مواد معدنی', en: 'Minerals', ps: 'منرالي مواد' },
